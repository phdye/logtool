...
light_blue = u"\u001b[38;5;44m"
bold_blue = u"\u001b[38;5;189m"
light_yellow = u"\u001b[38;5;186m"
white = u"\u001b[38;5;252m"
ansi_reset = u"\u001b[0m"

build_color = light_blue
test_color = light_yellow
body_color = white
line_color = light_yellow
...
def install(c, system=None):
    ...
    Options :
      ...
      --system  Install for all users rather than only for the current user.
